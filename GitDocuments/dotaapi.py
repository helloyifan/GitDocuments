...
def GetMatchDetails(key, match_id='1599068960'):
...
if __name__ == '__main__':
	...
	#print GetMatchDetails(key)

	json_string = GetMatchDetails(key) 
	...
	'''
	json_input = '{ "u\'duration\'": 1, "two": { "list": [ {"item":"A"},{"item":"B"} ] } }'
	decoded = json.loads(json_input)
	print "JSON parsing example: ", decoded['u\'duration\'']
